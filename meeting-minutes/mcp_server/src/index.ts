    ...
    tools: [
      {
        ...
        description:
          'Get comprehensive analysis of the meeting-minutes project structure and architecture',
        inputSchema: {
          type: 'object',
          properties: {},
          required: [],
      ...
      },
      {
        name: 'read_key_file',
        description:
          'Read content of a key project file (FRONTEND_MAIN_PAGE, TAURI_BACKEND_LIB, WHISPER_SERVER_CPP, etc.)',
        inputSchema: {
          type: 'object',
          properties: {
            key: {
        ...
        inputSchema: {
          ...
          properties: {
            path: {
              type: 'string',
              description:
                'Relative path from project root (e.g., "frontend/src/app/page.tsx")',
            },
          },
          required: ['path'],
        },
        ...
        inputSchema: {
          ...
          properties: {
            path: {
              type: 'string',
              description:
                'Relative path from project root (e.g., "frontend/src/components/Upload.tsx")',
            },
            content: {
              type: 'string',
        ...
        inputSchema: {
          ...
          properties: {
            path: {
              type: 'string',
              description:
                'Relative path from project root (e.g., "frontend/src/components")',
              default: '.',
            },
          },
          required: [],
      ...
      },
      {
        ...
        description:
          'Create a new React component with boilerplate code in the frontend/src/components directory',
        inputSchema: {
          type: 'object',
          properties: {
            componentName: {
              type: 'string',
              description:
                'Name of the component in PascalCase (e.g., MyNewComponent)',
      ...
      },
      {
        ...
        description:
          'Add a new Tauri command to the Rust backend with automatic registration',
        inputSchema: {
          type: 'object',
          properties: {
            commandName: {
              type: 'string',
              description:
                'Name of the command in snake_case (e.g., my_new_command)',
              pattern: '^[a-z_]+$',
            },
          },
    ...
    try {
      switch (name) {
                ...
                text: JSON.stringify(
                  {
                    ...
                    descriptions: Object.fromEntries(
                      Object.entries(KEY_FILES).map(([key, value]) => [
                        key,
                        value.description,
                      ])
                    ),
        ...
        case 'update_key_file':
          const { key: updateKey, content: newContent } = args as {
            key: string;
            content: string;
          };
        ...
        case 'write_file':
          const { path: writePath, content: writeContent } = args as {
            path: string;
            content: string;
          };
